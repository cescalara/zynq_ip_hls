...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.l2_trigger.autotvin_in_stream_V_data_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_keep_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_strb_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_user_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_last_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_id_V.dat"
         "c.l2_trigger.autotvin_in_stream_V_dest_V.dat"
         "c.l2_trigger.autotvin_out_stream_V_data_V.dat"
         "c.l2_trigger.autotvin_out_stream_V_keep_V.dat"
         "c.l2_trigger.autotvin_out_stream_V_strb_V.dat"
         "c.l2_trigger.autotvin_out_stream_V_user_V.dat"
         "c.l2_trigger.autotvin_out_stream_V_last_V.dat"
         ...
         "c.l2_trigger.autotvout_out_stream_V_user_V.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.l2_trigger.autotvout_out_stream_V_data_V.dat"
         "rtl.l2_trigger.autotvout_out_stream_V_keep_V.dat"
         "rtl.l2_trigger.autotvout_out_stream_V_strb_V.dat"
         "rtl.l2_trigger.autotvout_out_stream_V_user_V.dat"
