...
if {[file isfile l2_trigger.autotvin.dat]} {
	file delete -force l2_trigger.autotvin.dat
}

if {[file isfile l2_trigger.autotvout.dat]} {
	file delete -force l2_trigger.autotvout.dat
}
