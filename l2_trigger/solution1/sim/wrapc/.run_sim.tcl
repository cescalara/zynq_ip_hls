...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "l2_trigger.autotvin.dat"
	set constFileTvOut       "l2_trigger.autotvout.dat"
	set constFileHdlTvIn     "l2_trigger.autohdltvin.dat"
	set constFileHdlTvOut    "l2_trigger.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
