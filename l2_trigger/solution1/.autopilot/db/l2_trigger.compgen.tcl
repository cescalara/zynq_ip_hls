...
set ID 1
set MemName l2_trigger_sum_overP1
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName l2_trigger_data_shift1
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 17
set AddrRange 9216
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename l2_trigger_CTRL_BUS_axilite \
			name l2_trigger_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler l2_trigger_CTRL_BUS_s_axi
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_trig_pixel \
    op interface \
    ports { trig_pixel { O 32 vector } trig_pixel_ap_vld { O 1 bit } } \
} "
}
