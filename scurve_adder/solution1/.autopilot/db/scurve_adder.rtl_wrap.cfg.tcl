...
set structArgument0 [list 16 2 5 6 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axis<16, 2, 5, 6>" "struct ap_axis" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
