...
set ID 1
set MemName scurve_adder_sum_pix1
...
# Memory (RAM/ROM)  definition:
set ID 2
set MemName scurve_adder_dub_pix_keep_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 2
set AddrRange 8
...
# Memory (RAM/ROM)  definition:
set ID 3
set MemName scurve_adder_dub_pix_last_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 1
set AddrRange 8
...
# Memory (RAM/ROM)  definition:
set ID 4
set MemName scurve_adder_dub_pix_id_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 5
set AddrRange 8
...
# Memory (RAM/ROM)  definition:
set ID 5
set MemName scurve_adder_dub_pix_dest_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 6
set AddrRange 8
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 6 \
			corename scurve_adder_CTRL_BUS_axilite \
			name scurve_adder_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler scurve_adder_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_TDATA { I 16 vector } inStream_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_TKEEP { I 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_TSTRB { I 2 vector } } \
} "
} else {
