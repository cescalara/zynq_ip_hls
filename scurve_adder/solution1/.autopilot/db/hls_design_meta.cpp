...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStream_TDATA", 16, hls_in, 0, "axis", "in_data", 1),
	Port_Property("inStream_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("inStream_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("inStream_TKEEP", 2, hls_in, 1, "axis", "in_data", 1),
	Port_Property("inStream_TSTRB", 2, hls_in, 2, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "scurve_adder";
