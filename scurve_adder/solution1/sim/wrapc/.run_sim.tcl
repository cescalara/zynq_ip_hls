...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "scurve_adder.autotvin.dat"
	set constFileTvOut       "scurve_adder.autotvout.dat"
	set constFileHdlTvIn     "scurve_adder.autohdltvin.dat"
	set constFileHdlTvOut    "scurve_adder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
