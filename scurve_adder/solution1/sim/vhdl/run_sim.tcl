...
if {[file isfile scurve_adder.autotvin.dat]} {
	file delete -force scurve_adder.autotvin.dat
}

if {[file isfile scurve_adder.autotvout.dat]} {
	file delete -force scurve_adder.autotvout.dat
}
